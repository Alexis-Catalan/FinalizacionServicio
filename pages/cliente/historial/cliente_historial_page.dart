...
import 'package:radio_taxi_alfa_app/src/pages/cliente/historial/cliente_historial_controlador.dart';

class ClienteHistorialPage extends StatefulWidget {
  @override
  _ClienteHistorialPageState createState() => _ClienteHistorialPageState();
}

class _ClienteHistorialPageState extends State<ClienteHistorialPage> {

  ClienteHistorialControlador _con = new ClienteHistorialControlador();
          ...
          return ListView.builder(
            ...
            itemBuilder: (_, index) {
              return _cardHistorialInfo(
                ...
                snapshot.data[index].nombreTaxista,
        ...
        child: Column(
          children: [
            Row(
              children: [
                SizedBox(width: 5),
                Icon(Icons.local_taxi,color: utils.Colors.taxi),
                SizedBox(width: 5),
                Text(
                  'Taxista: ',
                  style: TextStyle(
