...
import 'package:radio_taxi_alfa_app/src/pages/cliente/calificacion_viaje/cliente_calificacion_viaje_controlador.dart';
...
class ClienteCalificacionViajePage extends StatefulWidget {
  @override
  _ClienteCalificacionViajePageState createState() => _ClienteCalificacionViajePageState();
}

class _ClienteCalificacionViajePageState extends State<ClienteCalificacionViajePage> {

  ClienteCalificacionViajeControlador _con = new ClienteCalificacionViajeControlador();
  ...
  Widget _txtCalificacionTaxista() {
    return Text(
      'CALIFICA A TU TAXISTA',
      style: TextStyle(
