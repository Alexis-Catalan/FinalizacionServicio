...
class TaxistaHistorialControlador {
  ...
  Future<List<HistorialViaje>> obtenerHistorial() async {
    print('se obtiene lista de informacion');
    return await _historialViajeProvider.obtenerIdTaxista(_authProvider.obtenerUsuario().uid);
  }

  void abrirHistorialDetalle(String id) {
    Navigator.pushNamed(context, 'taxista/historial/detalle', arguments: id);
  }
